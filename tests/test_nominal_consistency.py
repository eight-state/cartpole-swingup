"""Committed check that the saved n=6 nominal is 1 ms ZOH-consistent.

The headline README/METHOD claim is that ``results/nom_n6_gluck_cont.npz`` is
...
NOM_PATH = REPO / "results" / "nom_n6_gluck_cont.npz"
...
def test_nominal_zoh_one_step_defect_below_1e_10() -> None:
    ...
    n = (x_nom.shape[1] // 2) - 1
    assert n == 6, f"expected n=6 nominal, got n={n}"
