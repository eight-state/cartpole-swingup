...
It can be checked to ~1e-12 against the authoritative CasADi
``NLinkCartPole.f_num`` via the standalone :func:`verify_against_casadi`
utility -- which is NOT called automatically at construction; run it yourself
if you rely on this module. The GATE never uses this file -- the gate runs the
real CasADi ``rollout_zoh``. This is the training simulator only.
