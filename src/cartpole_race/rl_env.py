"""Gymnasium env wrapping the saturated n-link cart-pole for RL (n_links is a
constructor parameter; not n-specific).
...
Reward: shaped toward all n links upright + cart centered + low velocity,
