...
The success predicate requires every link within 5 degrees and 0.5 rad/s of upright, cart position within 2 m, cart velocity within 0.5 m/s, and a continuous five-second final hold.
