...
This is a continuous-time LQR (gain from the continuous-time algebraic Riccati
equation, CARE, via ``solve_continuous_are``) whose constant gain ``K`` is then
applied as a zero-order hold at the 1 kHz control rate.
