"""The locked 1 kHz sampled-state success predicate for the N11 replay."""
...
def longest_continuous_hold_s(
    ...
    """Return the longest interval across consecutive 1 kHz logged states in the success set."""
    run = best = 0
    for state in states:
