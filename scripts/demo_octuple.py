"""Clean, reproducible demo: closed-loop swing-up + balance of the n=8
(OCTUPLE) inverted pendulum on a cart, in the REAL saturated simulator —
rendered to results/demo_octuple.gif.

    uv run python scripts/demo_octuple.py

One deterministic rollout: exact-ZOH discrete TVLQR along the shipped dense
nominal over [0, 9 s], handoff to the static LQR, 5 s hold. Asserts the
