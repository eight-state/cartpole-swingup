...
class FastColloc:
    ...
    def __init__(
        ...
        *,
        ...
        us = ca.SX.sym("u")
        k1 = model.f(xs, us)
        k2 = model.f(xs + 0.5 * h * k1, us)
        k3 = model.f(xs + 0.5 * h * k2, us)
        k4 = model.f(xs + h * k3, us)
        self.F_step = ca.Function(
            "F", [xs, us], [xs + (h / 6.0) * (k1 + 2 * k2 + 2 * k3 + k4)])
    ...
    def solve(
        ...
        kw = dict(x0=z0, p=x0, lbx=self.lbx, ubx=self.ubx, lbg=0, ubg=0)
